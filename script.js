(function() {
  ...
  // Map Setup - FIXED (No Zoom/Drag allowed)
  function initializeMap() {
    ...
    chapters.forEach(function(chapter, index) {
      ...
      marker.bindPopup(
        ...
        '<span style="color:#e8d4b8;font-size:1.2rem;font-weight:bold;display:block;margin-bottom:0.8rem;">' + sanitizeHTML(chapter.name) + '</span>' +
